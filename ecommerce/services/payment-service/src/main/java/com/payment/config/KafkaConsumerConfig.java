...
/**
 * Separate consumer factory for the order-events topic.
 * Uses OrderEvent as the value type so the shared default consumer factory
 * (which uses PaymentEvent) does not conflict.
 */
@Configuration
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, OrderEvent> orderEventConsumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.payment.kafka.event,com.order.kafka.event");
