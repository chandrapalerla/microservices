...
/**
 * Separate consumer factory for the payment-events topic.
 * The default consumer factory uses OrderEvent as its value type;
 * payment events carry PaymentEvent — so a dedicated factory is required.
 */
@Configuration
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, PaymentEvent> paymentEventConsumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.order.kafka.event,com.payment.kafka.event");
